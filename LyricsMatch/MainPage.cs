...
namespace LyricsMatch
{
    public partial class MainPage : Form
    {
        ...
        private bool EstablishConnectionToMySQL()
        {
                ...
                {
                    MessageBox.Show( e.ToString(), "Connection error", MessageBoxButtons.OK, MessageBoxIcon.Error); 
                    return false;
                }
                finally
                {
        ...
        private void WhenCheckboxChecked(object sender, EventArgs e)
        {
        ...
        {
            WhenCheckboxChecked(sender, e);
        }

        private void cbxAuthor_CheckedChanged(object sender, EventArgs e)
        {
            WhenCheckboxChecked(sender, e);
        ...
        private void cbxLyrics_CheckedChanged(object sender, EventArgs e)
        {
            WhenCheckboxChecked(sender, e);
